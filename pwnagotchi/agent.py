...
class Agent(Client, Automata, AsyncAdvertiser, AsyncTrainer):
    def __init__(self, view, config, keypair):
        ...
        self._unscanned_channels = [] if 'channels' not in self._config['personality'] else self._config['personality'][
            'channels'].copy()
        self._view = view
    ...
    def get_access_points_by_channel(self):
        ...
        extra_channels = 15 if 'extra_channels' not in self._config['personality'] else self._config['personality'][
            'extra_channels']
        next_channels = []
        ai_enabled = False
        grouped = {}
